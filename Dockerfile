...
MAINTAINER Maximillian Brain "maxvbrain@gmail.com" copied from Jimmy Mesta "jimmy.mesta@gmail.com"

RUN git clone https://github.com/maximillianbrain1/go-flashpaper
